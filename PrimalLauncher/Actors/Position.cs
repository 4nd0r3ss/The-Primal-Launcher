...
namespace PrimalLauncher
{
    ...
    public class Position
    {
        ...
        public Position(XmlNode positionNode, uint zoneId = 0)
        {
            ZoneId = zoneId == 0 && positionNode != null ? positionNode.GetAttributeAsUint("zoneId") : zoneId;
        ...
        public void Set(string coords)
        {
            ...
            Position pos = new Position
            {
                ...
                SpawnType = Convert.ToUInt16(split[5])
            };
            World.Instance.RepositionPlayer(pos);
        }
    }
    ...
    public static class EntryPoints
    {
        public static Position GetStartPosition(uint startTown)
        {
            ...
            {
                case 1:
                    return new Position(1, 0.016f, 10.35f, -36.91f, 0.025f, 15);
                case 2:
                    return new Position(5, 369.5434f, 4.21f, -706.1074f, -1.26721f, 15);
                case 3:
                    return new Position(9, 5.364327f, 196.0f, 133.6561f, -2.849384f, 15);
                default:
        ...
        {          
            ...
            new Position(238, -2364.77f, -23.11f, -880.89f, -2.73f, 15),            //25 - the thornmarch
            new Position(239, 1489.97f, 302.12f, -269.31f, 0.70f, 15),              //25 - the howling eye
            new Position(240, 2508.68f, 247.37f, 2204.29f, 1.31f, 15),             //25 - the bowl of embers
